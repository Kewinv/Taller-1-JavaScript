...
**Materia:** Construcción de Software III  
...
|---|---|---|
| **Punto 1** — Variables, Tipos de Datos y Coerción | Parte A: Tipos de datos y typeof / Parte B: Coerción implícita y explícita | Juan Jose |
| **Punto 2** — Estructuras de Control | Parte A: Sistema de calificaciones / Parte B: Generador de tablas de multiplicar | Jhoseth |
| **Punto 3** — Arrays y sus Métodos | Parte A: Creación y manipulación básica / Parte B: Métodos funcionales (map, filter, reduce...) | Esteban Rubiano |
| **Punto 4** — Objetos en JavaScript | Parte A: Definición y manipulación de objetos / Parte B: Prototipos y Object Methods | Kevin Vélez |
| **Bonus** — Integración general | Sistema integrado con productos y curso de capacitación | Esteban Rubiano |
...
Taller-1-JavaScript/
├── Puntos/
│   ├── punto1.js    → Variables, tipos de datos y coerción
│   ├── punto2.js    → Estructuras de control
│   ├── punto3.js    → Arrays y métodos funcionales
│   └── punto4.js    → Objetos, prototipos y métodos
├── bonus.js         → Ejercicio integrador
├── index.js
└── README.md
```
...
### Bonus — Esteban Rubiano
Integración de los arrays de productos (Punto 3) con el sistema de cursos (Punto 4) para gestionar clientes inscritos en una capacitación y filtrar los aprobados.
